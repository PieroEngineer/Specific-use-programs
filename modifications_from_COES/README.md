...
3. **Utility functions**
   ...
   - `ISA_image_to_ascii(output_width=100)`: renders an ISA logo image as ASCII art (for fun/branding in console output).
...
- **Local inputs:**
  ...
  - `resources/logo-isa-2.jpg` – image used by the ASCII logo function.
- **Output:**
